      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Capture new launches instantly with AI-powered precision and safety
            checks.
          </p>
        </div>
        ...
        <section className="mb-20">
          <div className="flex flex-col items-center justify-center p-12 border border-white/10 rounded-2xl bg-black/20 backdrop-blur-sm">
            ...
            <p className="text-muted-foreground mb-6">
              Traditional sniping tools available soon.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  The biggest gains in crypto markets often happen at the exact
                  moment a new project launches or during unexpected pumps.
                  However, catching these opportunities manually is nearly
                  impossible due to speed, competition, and risk.
                </p>
                <p>
                  AI Snipe Mode continuously scans Solana, Base, and other
                  supported blockchains in real time. It detects new token
                  launches, monitors liquidity additions, verifies smart
                  contracts, and applies predefined safety filters such as
                  market cap limits, holder count, and advanced rug-check
                  mechanisms.
                </p>
              </div>
              ...
              <Card className="bg-black/40 border-primary/20 mt-6 relative overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-lg font-medium text-white font-mono">
                    "Enable snipe mode on Solana, snipe new tokens with a
                    maximum of $100, keep rug-check enabled."
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="relative">
              ...
              <Card className="glass-card border-white/10 h-[500px] flex items-center justify-center relative overflow-hidden group">
                <div className="absolute inset-0 bg-[url('/snipe-logo.jpeg')] bg-cover bg-center opacity-10 group-hover:opacity-20 transition-opacity duration-500" />
                <div className="relative z-10 text-center p-8">
                  ...
                  <p className="text-muted-foreground text-sm">
                    [Placeholder for UI Screenshot / Diagram showing real-time
                    scanning feed and executed trades]
                  </p>
                </div>
              </Card>
            </div>
