        ...
        <section className="mb-20">
          <div className="flex flex-col items-center justify-center p-12 border border-white/10 rounded-2xl bg-black/20 backdrop-blur-sm">
            ...
            <p className="text-muted-foreground mb-6">
              Manual configuration tools coming soon.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative order-2 md:order-1">
              ...
              <Card className="glass-card border-white/10 h-[500px] flex items-center justify-center relative overflow-hidden group">
                <div className="absolute inset-0 bg-[url('/gride-bot.jpeg')] bg-cover bg-center opacity-10 group-hover:opacity-20 transition-opacity duration-500" />
                <div className="relative z-10 text-center p-8">
                  ...
                  <p className="text-muted-foreground text-sm">
                    [Placeholder for Grid Bot Diagram showing buy/sell orders
                    executing within price range]
                  </p>
                </div>
              </Card>
            </div>
            ...
            <div className="space-y-6 order-1 md:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-bold leading-tight">
                Master the{" "}
                <span className="text-secondary">Ranging Market</span>
              </h2>

              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Grid trading is one of the most effective strategies during
                  ranging or moderately volatile markets. However, setting up
                  and managing grid bots on traditional platforms is complex and
              ...
              <Card className="bg-black/40 border-secondary/20 mt-6 relative overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-lg font-medium text-white font-mono">
                    "Create a grid bot for SOL between $180 and $220 with a
                    $2000 budget, using $100 per grid."
                  </p>
                </CardContent>
              </Card>
              ...
              <div className="pt-4">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start text-muted-foreground">
                    <div className="mt-1 mr-3 w-2 h-2 rounded-full bg-secondary shadow-[0_0_10px_#00E5FF]" />
                    <span>
                      Buys as the price drops and sells as the price rises
                    </span>
                  </li>
                  <li className="flex items-start text-muted-foreground">
                    <div className="mt-1 mr-3 w-2 h-2 rounded-full bg-secondary shadow-[0_0_10px_#00E5FF]" />
                    <span>
                      Continuously realizes profits and reopens new grid levels
                    </span>
                  </li>
                  <li className="flex items-start text-muted-foreground">
                    <div className="mt-1 mr-3 w-2 h-2 rounded-full bg-secondary shadow-[0_0_10px_#00E5FF]" />
                    <span>
                      Manages risk using trailing take-profit, dynamic grid
                      adjustments, and stop-loss protection
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p className="text-white/80 font-medium italic border-l-4 border-primary pl-4 py-2">
                Grid Trading Mode works 24/7, generating profits even while you
                sleep.
              </p>
            </div>
          </div>
